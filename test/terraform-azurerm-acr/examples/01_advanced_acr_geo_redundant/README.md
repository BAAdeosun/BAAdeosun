# Advanced Geo-Redundant Azure Container Registry
...
locals {
  custom_name                   = "acrtesting836d001"
  stack                         = "ectl"
  landing_zone_slug             = "db"
  location                      = "westeurope"
  resource_group_name           = "terraform-module-acr-rg1"
  sku                           = "PerGB2018"
...
module "acr" {
  ...
  # Region must be different to the one where ACR is already deployed.
