locals {
  ...
  name_components_list   = compact([local.service_slug, local.landing_zone_slug, local.application_id, local.workload_info, local.location_short, local.generated_random_value])
