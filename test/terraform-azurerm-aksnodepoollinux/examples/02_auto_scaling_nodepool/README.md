# Azure Kubernetes Service (AKS) Linux Node Pool with auto scaling enabled

This is an example for setting-up Linux Node Pool with auto scaling enabled to existing Azure Kubernetes Cluster
...
- Creates node pool from existing Kubernetes Cluster --> module "kubernetes_cluster"
...
locals {
  ...
  node_pools1 = {
    ...
    node_max_count           = 6
    agent_max_pods           = 110
    linux_message_of_the_day = "What's Up Doc? Can We Rock"
    node_min_count           = 3
    nodepool_mode            = "User"
...
module "aks" {
  ...
  agents_max_count                    = local.agents_max_count
  agents_min_count                    = local.agents_min_count
...
| <a name="module_nodepool_linux02"></a> [nodepool\_linux02](#module\_nodepool\_linux02) | ../../module | n/a |
