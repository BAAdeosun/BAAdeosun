# Basic Azure Kubernetes Service (AKS) Linux Node Pool

This is an example for setting-up Linux Node Pool with and existing Azure Kubernetes Cluster
...
| <a name="module_nodepool_linux01"></a> [nodepool\_linux01](#module\_nodepool\_linux01) | ../../module | n/a |
