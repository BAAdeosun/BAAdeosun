...
locals {
  ...
  source_image_id = "/subscriptions/9cd5e069-244a-4cfb-b16b-d80ef255245d/resourceGroups/rg-ectl-os-images/providers/Microsoft.Compute/galleries/ectl_image_gallery/images/gen-winsrv-2019-dc/versions/1.0.0"
