  ...
  vm_extension = [
    {
      ...
      settings             = "{ \"workspaceId\": \"${module.log_analytics.log_analytics_workspace_workspace_id}\" }"
      protected_settings   = "{ \"workspaceKey\": \"${module.log_analytics.log_analytics_workspace_primary_shared_key}\" }"
    }
  ]
}
```
