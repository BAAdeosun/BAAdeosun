...
This is an example for setting-up a Keyvault with Network ACLs enabled.
This example
...
- A Keyvault with Network ACLs in place --> module "keyvault"
...
locals {
  ...
  location            = "westeurope"
  resource_group_name = "rg-tst-euw-terraform-keyvault-02"
  ...
  network_acls = {
    ...
    virtual_network_subnet_ids = [
      "/subscriptions/9cd5e069-244a-4cfb-b16b-d80ef255245d/resourceGroups/karminadel-j2c-ca001-ladr/providers/Microsoft.Network/virtualNetworks/ps-sbx-vnet-001/subnets/snet-j2c-test-kv-01"
    ]
  }
}
