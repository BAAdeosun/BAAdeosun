# Keyvault with Private Endpoints

This is an example for setting-up a Keyvault with Private Endpoints attached.
This example
...
| <a name="module_subnet"></a> [subnet](#module\_subnet) | git::ssh://git@ssh.dev.azure.com/v3/ECTL-AZURE/ECTL-Terraform-Modules/terraform-azurerm-subnet//module | develop |
