# Keyvault with Managed Identity Access Policies Attached

This is an example for setting-up a Keyvault with Managed Identity-based access policies attached.
This example
