# Basic Azure Kubernetes Service (AKS) Windows Node Pool

This is an example for setting-up Windows Node Pool with and existing Azure Kubernetes Cluster
...
| <a name="module_nodepool_windows01"></a> [nodepool\_windows01](#module\_nodepool\_windows01) | ../../module | n/a |
